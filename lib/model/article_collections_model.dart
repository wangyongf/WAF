...
part 'article_collections_model.g.dart';


@JsonSerializable()
class ArticleCollectionsModel extends Object {
  ...
  ArticleCollectionsModel(this.data,this.errorCode,this.errorMsg,);

  factory ArticleCollectionsModel.fromJson(Map<String, dynamic> srcJson) => _$ArticleCollectionsModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$ArticleCollectionsModelToJson(this);

...
part 'knowledge_articles_model.g.dart';


@JsonSerializable()
class KnowledgeArticlesModel extends Object {
  ...
  KnowledgeArticlesModel(this.data,this.errorCode,this.errorMsg,);

  factory KnowledgeArticlesModel.fromJson(Map<String, dynamic> srcJson) => _$KnowledgeArticlesModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$KnowledgeArticlesModelToJson(this);
